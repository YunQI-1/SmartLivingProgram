...
import com.jsu.old.mapper.ProfessionalQualificationsMapper;
...
public class ProfessionalQualificationsServiceImpl extends ServiceImpl<ProfessionalQualificationsMapper, ProfessionalQualifications> implements ProfessionalQualificationsService {
    ...
    @Override
    public List<ProfessionalQualifications> getProfessionalQualificationsDetail(QueryDTO queryDTO) {
        return professionalQualificationsMapper.getProfessionalQualificationsDetail(queryDTO);
