...
import com.jsu.old.mapper.StudentAwardMapper;
...
public class StudentAwardServiceImpl extends ServiceImpl<StudentAwardMapper, StudentAward> implements StudentAwardService {
    ...
    @Override
    public List<StudentAwardVO> getStudentAwardDetail(QueryDTO queryDTO) {
        return studentAwardMapper.getStudentAwardDetail(queryDTO);
    }
}
