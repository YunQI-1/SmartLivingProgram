...
public class SoftwareCopyrightController {
     ...
     * 查询学生详细的软著情况
     */
    @PostMapping ("/getSoftwareCopyright/getSoftwareCopyrightDetail")
    public Result getSoftwareCopyrightDetail(@RequestBody QueryDTO queryDTO){
        log.info("管理端根据学生学号和软著名称查询学生软著情况");
        return Result.success(softwareCopyrightService.getSoftwareCopyrightDetail(queryDTO));
    }
