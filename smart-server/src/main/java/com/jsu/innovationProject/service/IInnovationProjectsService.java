 ...
 * @since 2025-03-04
 */
public interface IInnovationProjectsService extends IService<InnovationProjects> {
    ...
    void exportInnovationProject(HttpServletResponse response, ExportConfigDTO exportConfigDTO);
}
